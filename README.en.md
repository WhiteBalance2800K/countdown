...
- [x] Add, edit, archive, and restore countdown items.
...
- [x] Expired items leave Active automatically and appear in Overdue.
...
- [x] Immersive mode with the three nearest items labeled and hover details for the rest.
