...
enum L10n {
    ...
    private static let strings: [AppLanguage: [String: String]] = [
        .simplifiedChinese: [
            ...
            "customReminderOffsets": "Bark 提醒日期", "customReminderOffsetsHelp": "将提醒：%@", "reminderDueDay": "到期当天", "reminderDaysBefore": "提前 %d 天", "reminderDaysUnit": "天前", "reminderAddDate": "加入",
        ...
        .english: [
            ...
            "customReminderOffsets": "Bark reminder dates", "customReminderOffsetsHelp": "Reminders: %@", "reminderDueDay": "Due day", "reminderDaysBefore": "%d days before", "reminderDaysUnit": "days before", "reminderAddDate": "Add",
