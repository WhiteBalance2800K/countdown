...
enum L10n {
    ...
    private static let strings: [AppLanguage: [String: String]] = [
        .simplifiedChinese: [
            ...
            "customReminderOffsets": "Bark 提醒日期", "customReminderOffsetsHelp": "将提醒：%@", "reminderDueDay": "到期当天", "reminderDaysBefore": "提前 %d 天", "reminderAddDate": "加入",
            "reminderSettingsTitle": "提醒日期在项目里设置", "reminderSettingsHelp": "编辑项目时可点选快捷日期，也可以从日历加入具体提醒日。",
        ...
        .english: [
            ...
            "customReminderOffsets": "Bark reminder dates", "customReminderOffsetsHelp": "Reminders: %@", "reminderDueDay": "Due day", "reminderDaysBefore": "%d days before", "reminderAddDate": "Add",
            "reminderSettingsTitle": "Set reminder dates per item", "reminderSettingsHelp": "Edit an item to pick quick dates or add a calendar date for Bark reminders.",
