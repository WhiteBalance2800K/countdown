...
enum L10n {
    ...
    private static let strings: [AppLanguage: [String: String]] = [
        .simplifiedChinese: [
            ...
            "appearance": "外观", "appearanceHelp": "手动选择跟随系统、浅色或深色模式", "appearanceSystem": "系统", "appearanceLight": "白", "appearanceDark": "黑",
            ...
            "customReminderOffsets": "Bark 提醒日期", "customReminderOffsetsHelp": "将提醒：%@", "reminderDueDay": "到期当天", "reminderDaysBefore": "提前 %d 天", "reminderDaysUnit": "天前", "reminderAddDate": "加入", "reminderSoundPreview": "试听提醒音",
        ...
        .english: [
            ...
            "appearance": "Appearance", "appearanceHelp": "Choose system, light, or dark mode manually", "appearanceSystem": "System", "appearanceLight": "Light", "appearanceDark": "Dark",
            ...
            "customReminderOffsets": "Bark reminder dates", "customReminderOffsetsHelp": "Reminders: %@", "reminderDueDay": "Due day", "reminderDaysBefore": "%d days before", "reminderDaysUnit": "days before", "reminderAddDate": "Add", "reminderSoundPreview": "Preview reminder sound",
