...
![Countdown dashboard](Resources/screenshot-dashboard.png)

![Countdown settings](Resources/screenshot-settings.png)
...
- Manual drag ordering with a lightweight edit mode.
...
- UI and push preferences: macOS `UserDefaults` via SwiftUI `@AppStorage`
